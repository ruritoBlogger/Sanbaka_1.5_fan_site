...
class MyDocument extends Document implements CustomDocumentInterface {
  ...
  url = "https://sanbaka-fun-site.web.app";
  title = `さんばか1.5周年ファンサイト`;
  description =
    "にじさんじに所属されているさんばかの皆さんがデビューしてから1.5周年を記念した非公式ファンサイトです.";
